                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border" data-size="6" title="Select State" name="state_unid" required>
                                ...
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border" data-size="6" title="Select State" name="lga_unid" required>
                                            @foreach($lgas as $lga)
                                ...
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border" data-size="6" title="Select State" name="area_unid" required>
                                ...
                                <div class="col-xl-4">
                                    <div class="submit-field">
                                        ...
                                        <select class="selectpicker with-border" data-size="6" title="Select State" name="asst_unid" required>
